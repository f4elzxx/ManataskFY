				...
				<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="card">
							<div class="card-body">
								<div class="m-sm-3">
									<form id="formLogin" action="../../actions/validalogin.php" method="POST">  
										<div class="mb-3">
										...
										<div>
											<div class="form-check align-items-center">
												<input id="customControlInline" type="checkbox" class="form-check-input" value="Lembre-se" name="Lembre-se" checked>
												<label class="form-check-label text-small" for="customControlInline">Lembre-se</label>
											</div>
										</div>
										<div class="d-grid gap-2 mt-3">
										<button type="submit" class="btn btn-lg btn-150 btn-primary">Login</button>
										</div>
									</form>
								</div>
							</div>
