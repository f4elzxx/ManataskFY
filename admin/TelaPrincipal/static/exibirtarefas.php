...
<head>
	...
	<title>Tarefas | Manataskfy</title>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Tarefas</strong> </h1>
						...
						<div class="col-12 col-lg-8 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Tarefas adicionadas</h5>
								</div>
								<table class="table table-hover my-0">
									<thead>
										<tr>
											...
											<th class="d-none d-md-table-cell">Excluir</th>
											<th class="d-none d-md-table-cell">Editar</th>
										</tr>
									</thead>
									<tbody>
								<?php foreach ($att as $linha) { ?>
                             <tr>
                                <td><?= $linha['titulo']; ?></td>
                                <td><?= $linha['descricao']; ?></td>
                                <td><?= date_format(date_create($linha['data_criacao']),"d/m/Y"); ?></td>
                                <td><?=date_format(date_create($linha['prazo']),"d/m/Y"); ?></td>
                                <td><?= $linha['tipo']; ?></td>
								<td><a class="btn btn-150 btn-primary" href="../../actions/apagar.php?id=<?= $linha['id']; ?>" role="button">Excluir</a></td>
								<td><a class="btn btn-150 btn-primary" href="editartarefa.php?id=<?= $linha['id']; ?>" role="button">Editar</a></td>
                             </tr>
                        <?php } ?>
									</tbody>
								</table>
