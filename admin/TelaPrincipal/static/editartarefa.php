...
<head>
	...
	<title> Editar Tarefa | Manataskfy</title>
	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<main class="content">
				...
				<form action="../../actions/editar_atividade.php" method='POST'>

					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Editar Tarefas</h1>
						</a>
					</div>
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="card">
								...
								<div class="card-body">
                                        <input type="text" class="form-control" name="titulo" id="titulo" value="<?= $att['titulo']; ?>">
								</div>
							</div>
							...
							<div class="card">
								...
								<div class="card-body">
                                        <input type="text" class="form-control" name="descricao" id="descricao" value="<?= $att['descricao']; ?>">
								</div>
							</div>
								...
								<div class="card-body">
									<div>
										<label class="form-check">
											<input class="form-check-input" type="radio" id="diaria" name="tipo" value="diária" <?= $att['tipo'] == 'diária' ? 'checked' : ''; ?>>
										...
										<label class="form-check">
											<input class="form-check-input" type="radio" id="esporte" name="tipo" value="esporte" <?= $att['tipo'] == 'esporte' ? 'checked' : ''; ?>>
											<span class="form-check-label">
												Esportes
											</span>
										</label>
										<label class="form-check">
											<input class="form-check-input" type="radio" id="estudos" name="tipo" value="estudos" <?= $att['tipo'] == 'estudos' ? 'checked' : ''; ?>>
											<span class="form-check-label">
												Estudos
											</span>
										</label>
										<label class="form-check">
											<input class="form-check-input" type="radio" id="outro" name="tipo" value="outro" <?= $att['tipo'] == 'outro' ? 'checked' : ''; ?>>
											<span class="form-check-label">
												Outros
											</span>
										</label>
							...
							<div class="card">
								...
								<div 	class="card-body">
									<input type="date" name="dataini" id="data_criacao" class="form-control" id="data_criacao" value="<?= date_format(date_create($att['data_criacao']),"Y-m-d"); ?>">
								</div>
							</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<input type="date" name="dataterm" id="prazo" class="form-control" value="<?= $att['prazo']; ?>" required>
								</div>
							</div>
							<br><br>
							<input type="hidden" name="id" value="<?= $att['id']; ?>">
							<button type="submit" name="submit"  id="submit" class="btn btn-150 btn-secondary">Editar
